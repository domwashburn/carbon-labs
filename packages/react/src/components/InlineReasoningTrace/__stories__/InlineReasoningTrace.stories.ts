...
const sampleReasoningSteps = [
  {
    ...
    stepContent:
      'Analyzing the input data to identify key patterns and relationships.',
    delimiter: ' ',
  },
  {
    stepLabel: 'Pattern Recognition',
    stepContent:
      'Identified three distinct patterns in the dataset that correlate with the expected outcome.',
    delimiter: ' ',
  },
  {
    stepLabel: 'Hypothesis Formation',
    stepContent:
      'Based on the patterns, formulating a hypothesis that the primary factor is temporal correlation.',
    delimiter: ' ',
  },
  {
    stepLabel: 'Validation',
    stepContent:
      'Testing the hypothesis against historical data shows 87% accuracy, confirming the temporal correlation theory.',
    delimiter: ' ',
  },
  {
    stepLabel: 'Conclusion',
    stepContent:
      'The analysis confirms that temporal patterns are the primary driver of the observed behavior.',
  },
];
  ...
  args: {
    ...
    steps: [
      longReasoningStep,
      {
        stepLabel: 'Summary',
        stepContent:
          'Based on the comprehensive analysis, we can proceed with confidence.',
      },
    ],
    openByDefault: true,
  },
...
export const IRTWithStructuredContent: Story = {
  name: 'Inline Reasoning Trace • Structured Content',
  args: {
    triggerText: 'Generated implementation plan',
    steps: [
      {
        stepLabel: 'Define response schema',
        stepContent: [
          {
            type: 'text',
            content:
              'The step content can be produced as serializable objects before being rendered by the component.',
          },
          {
            type: 'code',
            label: 'Structured output',
            language: 'ts',
            code: `const stepContent = [
  {
    type: 'text',
    content: 'Explain the implementation decision.',
  },
  {
    type: 'code',
    language: 'ts',
    code: 'type StepContentItem = StepTextContentItem | StepCodeContentItem;',
  },
];`,
          },
        ],
      ...
      {
        stepLabel: 'Render code-only output',
        stepContent: [
          {
            type: 'code',
            language: 'json',
  ...
  args: {
    ...
    steps: [
      ...
      },
      {
        stepLabel: 'Conclusion',
        stepContent:
          'Based on both public and restricted data, the conclusion is valid.',
        hasOverlay: false,
        isGoverned: false,
      },
    ],
    ...
    steps: [
      {
        ...
        stepContent:
          'Gathering relevant data from multiple sources including databases, APIs, and user inputs.',
      },
      {
        stepLabel: 'Step 2: Data Validation',
        stepContent:
          'Validating the collected data for completeness, accuracy, and consistency.',
      },
      {
        stepLabel: 'Step 3: Preprocessing',
        stepContent:
          'Cleaning and transforming the data into a suitable format for analysis.',
      },
      {
        stepLabel: 'Step 4: Feature Extraction',
        stepContent:
          'Identifying and extracting key features that are relevant to the analysis.',
      },
      {
        stepLabel: 'Step 5: Pattern Analysis',
        stepContent:
          'Analyzing patterns and trends in the extracted features to identify correlations.',
      },
      {
        stepLabel: 'Step 6: Hypothesis Formation',
        stepContent:
          'Formulating hypotheses based on the observed patterns and domain knowledge.',
      },
      {
        stepLabel: 'Step 7: Statistical Testing',
        stepContent:
          'Applying statistical tests to validate the hypotheses and measure significance.',
      },
      {
        stepLabel: 'Step 8: Model Building',
        stepContent:
          'Constructing predictive models based on validated hypotheses and patterns.',
      },
      {
        stepLabel: 'Step 9: Validation',
        stepContent:
          'Testing the models against holdout data to ensure generalization and accuracy.',
      },
      {
        stepLabel: 'Step 10: Conclusion',
        stepContent:
          'Synthesizing findings into actionable insights and recommendations for stakeholders.',
      },
    ],
    openByDefault: true,
  },
  ...
  args: {
    ...
    steps: [
      ...
      },
      {
        ...
        stepContent:
          'An anomaly was detected in the data that requires attention.',
        hasOverlay: true,
        isGoverned: false,
      },
      {
  ...
  args: {
    ...
    steps: [
      ...
      },
      {
        ...
        stepContent:
          'Creating new configuration files for the deployment environment.',
        taskType: 'create',
      },
      {
        stepLabel: 'Edit Settings',
        stepContent:
          'Modifying application settings to match production requirements.',
        taskType: 'edit',
      },
      {
        stepLabel: 'Update Dependencies',
        stepContent:
          'Updating project dependencies to their latest stable versions.',
        taskType: 'update',
      },
      {
        stepLabel: 'Run Tests',
    ...
    steps: [
      {
        ...
        stepContent:
          "Considering the problem space and potential approaches to solve the user's request.",
        taskType: 'thinking',
      },
      {
        stepLabel: 'Analyzing Requirements',
        stepContent:
          'Breaking down the requirements into specific, actionable components and identifying dependencies.',
        taskType: 'analyzing',
      },
      {
        stepLabel: 'Searching Knowledge Base',
        stepContent:
          'Querying relevant documentation, code examples, and best practices from the knowledge base.',
        taskType: 'searching',
      },
      {
        stepLabel: 'Planning Approach',
        stepContent:
          'Developing a step-by-step plan to implement the solution efficiently and correctly.',
        taskType: 'planning',
      },
      {
        stepLabel: 'Executing Solution',
        stepContent:
          'Implementing the planned solution with attention to code quality and best practices.',
        taskType: 'executing',
      },
      {
        stepLabel: 'Reviewing Output',
        stepContent:
          'Examining the generated solution for correctness, completeness, and potential improvements.',
        taskType: 'reviewing',
      },
      {
        stepLabel: 'Validating Results',
        stepContent:
          'Verifying that the solution meets all requirements and handles edge cases appropriately.',
        taskType: 'validating',
      },
      {
        stepLabel: 'Final Reasoning',
        stepContent:
          'Synthesizing all steps into a coherent explanation of the solution and its rationale.',
        taskType: 'reasoning',
      },
    ],
    openByDefault: true,
